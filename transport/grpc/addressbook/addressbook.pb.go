...
type Address struct {
	...
	Details              map[string]*any.Any  `protobuf:"bytes,8,rep,name=Details,proto3" json:"Details,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (m *Address) GetDetails() map[string]*any.Any {
	if m != nil {
		return m.Details
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]*any.Any)(nil), "addressbook.Address.DetailsEntry")
}
...
var fileDescriptor_1eb1a68c9dd6d429 = []byte{
	...
	,
}
